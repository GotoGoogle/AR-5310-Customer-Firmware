...
//<< [CTFN-MGM-019] Camille Wu: Follow standard TR-098 to add the information of static IP devices on LAN side into LAN hosts table, 2012/02/15
   CMS_MSG_CT_POLLING_HOST_UPDATE               = 0x10000275, /**< Sent from ct_polling to ssk to trigger static lan hosts update */	
//>> [CTFN-MGM-019] End
...
//<< [CTFN-IPV6-003] Alex Wang : Enhanced RADVD to support more settings, 2011/05/02
   CMS_MSG_RECEIVE_RA_MTU_CHANGED               = 0x100002B0,
//>> [CTFN-IPV6-003] end   
#ifdef BRCM_WLAN
   ...
   //<< [CTFN-WIFI-013] Joba Yang : Enable the workaround "Lock Device PIN" for Wi-Fi Protected Setup PIN brute force vulnerability
   CMS_MSG_EDIT_WPS_DEVICE_PIN_LOCK_DOWN_MECHANISM = 0x1000303, /**< Notification Wlmngr to change lock down mechanism. */
   //>> [CTFN-WIFI-013] End
...
//<< [CTFN-3G-001] MHTsai: Support 3G feature, 2010/08/09
   CMS_MSG_WAN_LINK_UP_3G      = 0x10000884,  /**<wan link is up only for 3G> */
   CMS_MSG_WAN_LINK_DOWN_3G    = 0x10000885,  /**<wan link is down only for 3G> */
   CMS_MSG_WAN_3G_CONNECT      = 0x10000886,  /**<wan link is up only for 3G> */
   CMS_MSG_WAN_3G_DISCONNECT   = 0x10000887,  /**<wan link is down only for 3G> */
   CMS_MSG_GET_3GBACKUP_STATUS = 0x10000888,  /**<get 3G wan connection status> */
   CMS_MSG_CONFIG_3GBACKUP     = 0x10000889,  /**<3G backup configuration > */
//>> [CTFN-3G-001] End
...
//<< [CTFN-3G-001] MHTsai: Support 3G feature, 2010/08/09
   CMS_MSG_DGATEWAY_CHANGED	 = 0x10000892,  /**<change defaultgateway > */
   CMS_MSG_DNS_CHANGED	 = 0x10000893,  /**<change DNS > */
   CMS_MSG_UPDATE_DONGLE_STATE= 0x10000894,
//>> [CTFN-3G-001] End
...
//<< [CTFN-NRUT-002] Leo Ting :  Support DHCP option 121 for DHCP client
#ifdef CTCONFIG_NTWK_DHCPC_OPT121
		   CMS_MSG_DHCPC_OPTION121			 = 0x10005566, /**< Sent from dhcp client when get option 121 */
#endif /* CTCONFIG_NTWK_DHCPC_OPT121 */
//>> [CTFN-NRUT-002] Leo Ting :  Support DHCP option 121 for DHCP client
...
typedef enum {
   NETWORK_ACCESS_CONFIG_DISABLED   = 0,  /**< access denied */
   NETWORK_ACCESS_CONFIG_LAN_SIDE   = 1,  /**< access from LAN */
   NETWORK_ACCESS_CONFIG_WAN_SIDE   = 2,  /**< access from WAN */
   NETWORK_ACCESS_CONFIG_ENABLE    = 3   /**< access from LAN or WAN */
} ConfigNetworkAccessMode;
