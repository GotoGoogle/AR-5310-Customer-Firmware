...
static bp_elem_t * g_BoardParms[] = {g_bcm96318AT_1341N1,g_bcm96318AT_1341N3,g_bcm96318A_1441N1, g_bcm96318AT_1341N2, g_bcm96318sv, g_bcm96318ref, g_bcm96318ref_p300, g_bcm96318sv_serled, g_bcm96318sv_sersw, 0};
...
int BpGetWirelessSesExtIntrGpio( unsigned short *pusValue )
{
    ...
    pelem = BpGetElem(bp_usExtIntrSesBtnWireless,  &start_elem, bp_last);
    if (bp_usExtIntrSesBtnWireless != pelem->id) 
    {
       *pusValue = BP_NOT_DEFINED;
        ret      = BP_VALUE_NOT_DEFINED;
    }
